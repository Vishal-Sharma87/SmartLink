package com.spring.springboot.smartlink.dto.emailComponents;
...
public class EmailContentBuilder {
    ...
    public EmailDto getEmailDtoWithContentUrlShortenedConfirmation(String generatedHash, String longUrl, String email) {
        ...
        String shortUrl = (companyEndpoint == null || companyEndpoint.isBlank() ? generatedHash : companyEndpoint.replaceAll("/+$", "") + "/" + generatedHash);
    ...
    public EmailDto getEmailDtoWithContentPermanentBlockNotification(String email) {
        ...
        String content = """
                ...
                permanently restricted from using the SmartLink service.
